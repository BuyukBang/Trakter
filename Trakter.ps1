...
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=2021" "Releases=Releases" "NoReleases=No Releases"'
...
$r.content.split("`r`n") | select-string -Pattern 'tt\d{7,8}' -AllMatches | foreach {$_.matches.value} | sort | get-unique > imdb.txt
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=2020" "Releases=Releases" "NoReleases=No Releases"'
...
$r.content.split("`r`n") | select-string -Pattern 'tt\d{7,8}' -AllMatches | foreach {$_.matches.value} | sort | get-unique > imdb.txt
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=2019" "Releases=Releases" "NoReleases=No Releases"'
...
$r.content.split("`r`n") | select-string -Pattern 'tt\d{7,8}' -AllMatches | foreach {$_.matches.value} | sort | get-unique > imdb.txt
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=2018" "Releases=Releases" "NoReleases=No Releases"'
...
$r.content.split("`r`n") | select-string -Pattern 'tt\d{7,8}' -AllMatches | foreach {$_.matches.value} | sort | get-unique > imdb.txt
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=2017" "Releases=Releases" "NoReleases=No Releases"'
...
$r.content.split("`r`n") | select-string -Pattern 'tt\d{7,8}' -AllMatches | foreach {$_.matches.value} | sort | get-unique > imdb.txt
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=2016" "Releases=Releases" "NoReleases=No Releases"'
...
$r.content.split("`r`n") | select-string -Pattern 'tt\d{7,8}' -AllMatches | foreach {$_.matches.value} | sort | get-unique > imdb.txt
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=2015" "Releases=Releases" "NoReleases=No Releases"'
...
$r.content.split("`r`n") | select-string -Pattern 'tt\d{7,8}' -AllMatches | foreach {$_.matches.value} | sort | get-unique > imdb.txt
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=Horror" "Releases=DONT_MODIFY" "NoReleases=DONT_MODIFY"'
...
$r.content.split("`r`n") | select-string -Pattern 'tt\d{7,8}' -AllMatches | foreach {$_.matches.value} | sort | get-unique > imdb.txt
iex 'flexget execute -v --no-cache --discover-now --cli-config "ListName=Turkish" "Releases=DONT_MODIFY" "NoReleases=DONT_MODIFY"'
}
