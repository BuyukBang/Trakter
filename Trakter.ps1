...
function DoJobs {
  ...
  UpdateList '"Releases=Horror Releases" "NoReleases=Horror No Releases"' 'release_date=2015,&user_rating=5.0,&num_votes=10000,&genres=horror,'
  UpdateList '"Releases=Turkish Releases" "NoReleases=Turkish No Releases"' 'release_date=2015,&user_rating=5.0,&num_votes=3000,&countries=tr,'
}
